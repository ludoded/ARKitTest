...
//        performSegue(withIdentifier: SegueIdentifier.showObjects.rawValue, sender: nil)
        virtualObjectSelectionViewController(VirtualObjectSelectionViewController(), didSelectObject: VirtualObject.testModel)
    }
